                        ...
                        <form action="{{ route('branch.update') }}" method="post">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input name="created" type="datetime-local" required class="form-control" id="ud-created">
                                </div>
                        ...
                        <form action="{{ route('branch.create') }}" method="post">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input name="created" type="datetime-local" min='1999-06-21T08:23' max='2099-06-21T08:23' required class="form-control" id="cr-created">
                                </div>
